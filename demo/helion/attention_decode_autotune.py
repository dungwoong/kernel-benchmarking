"""
Times a Helion autotune of the attention kernel 
...
from workload_shapes import ATTENTION_DECODE_ARGS
...
if __name__ == "__main__":
    ...
    prob_args = ATTENTION_DECODE_ARGS.with_config(args.config)
    tensors = tuple(t.transpose(1, 2) for t in prob_args.tensors(MASK))
    autotune_runner(Attention, prob_args, MASK, "attn_decode", args.csv, output_cls=AttentionOutput, tensors=tensors)
