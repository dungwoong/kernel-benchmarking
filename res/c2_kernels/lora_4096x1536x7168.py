    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 192, 132):
        ...
        for k in cutlass.range(0, 112, 1):
          st_6693_pipe.consumer_wait(st_6683_cstate, st_6693_pipe.consumer_try_wait(st_6683_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8448, st_6683, st_6693, wgmma_acc_6660, st_6683_cstate, st_6683_cstate, wgmma_acc_6660_accumulate, -1)
          wgmma_acc_6660_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_6693_pipe.consumer_release(st_6683_cstate)
          st_6683_cstate.advance()
          st_6693_pstate.advance()
        st_6673_pipe.consumer_wait(st_6663_cstate, st_6673_pipe.consumer_try_wait(st_6663_cstate))
        mma.accumulating_gemm_ss(tidx_, tiled_mma_8547, st_6663, st_6673, wgmma_acc_6660, st_6663_cstate, st_6663_cstate, wgmma_acc_6660_accumulate, -1)
        wgmma_acc_6660_accumulate = True
        cute.nvgpu.warpgroup.wait_group(0)
