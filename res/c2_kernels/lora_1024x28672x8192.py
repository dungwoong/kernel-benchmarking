...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_6660_epi_smem_layout = shared.get_smem_layout_row_major(cutlass.BFloat16, 128, 64, 2)
    wgmma_acc_6660_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 256, False)
    ...
    c_tma_atom_1, c_tma_tensor_1 = shared.get_tma_epi_tensor_and_atom(c, wgmma_acc_6660_epi_smem_layout, 128, 64)
    ...
    self.kernel(a, b, xa, lora_b, st_6683_layout, st_6693_layout, st_6663_layout, st_6673_layout, c, wgmma_acc_6660_epi_smem_layout, wgmma_acc_6660_tiled_mma, tiled_mma_8448, tiled_mma_8547, tiled_mma_8568, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, st_6683_layout, st_6693_layout, st_6663_layout, st_6673_layout, c: cute.Tensor, wgmma_acc_6660_epi_smem_layout, wgmma_acc_6660_tiled_mma, tiled_mma_8448, tiled_mma_8547, tiled_mma_8568, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5):
    ...
    shared.smem_add_shared_tensor(SharedStorage_t, 'wgmma_acc_6660_epi_smem_ptr', cutlass.BFloat16, wgmma_acc_6660_epi_smem_layout, 1024)
    ...
    wgmma_acc_6660_epi_smem = shared.smem_get_tensor(smem_, 'wgmma_acc_6660_epi_smem_ptr', wgmma_acc_6660_epi_smem_layout)
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 896, 132):
        ...
        wgmma_acc_6660 = mma.get_acc(wgmma_acc_6660_tiled_mma, 128, 256, cutlass.Float32)
        wgmma_acc_6660_accumulate = False
        for k in cutlass.range(0, 128, 1):
          st_6693_pipe.consumer_wait(st_6693_cstate, st_6693_pipe.consumer_try_wait(st_6693_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8448, st_6683, st_6693, wgmma_acc_6660, st_6693_cstate, st_6693_cstate, wgmma_acc_6660_accumulate, -1)
          wgmma_acc_6660_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_6693_pipe.consumer_release(st_6693_cstate)
          st_6683_pstate.advance()
          st_6693_cstate.advance()
        st_6673_pipe.consumer_wait(st_6673_cstate, st_6673_pipe.consumer_try_wait(st_6673_cstate))
        mma.accumulating_gemm_ss(tidx_, tiled_mma_8547, st_6663, st_6673, wgmma_acc_6660, st_6673_cstate, st_6673_cstate, wgmma_acc_6660_accumulate, -1)
        wgmma_acc_6660_accumulate = True
        cute.nvgpu.warpgroup.wait_group(0)
        st_6673_pipe.consumer_release(st_6673_cstate)
        st_6673_pstate.advance()
        st_6673_cstate.advance()
        store.mma_epilogue_tma(tiled_mma_8568, c_tma_tensor_1, c_tma_atom_1, wgmma_acc_6660_epi_smem, wgmma_acc_6660, 128, 256, sched_coord[0], sched_coord[1], tidx_, warpidx_, cutlass.Float32)
        ...
        for sched_idx in cutlass.range(cute.arch.block_idx()[0], 896, 132):
          ...
          for k in cutlass.range(0, 128, 1):
            if cutlass.const_expr(True):
              st_6693_pipe.producer_acquire(st_6683_pstate, st_6693_pipe.producer_try_acquire(st_6683_pstate))
              mcast_mask_2, cta_coord_2, cta_layout_2 = shared.get_multicast_info(None, -1)
              shared.tma_copy(a_tma_atom_2, a_tma_tensor_2, st_6683, 128, 64, sched_coord[0], k, st_6693_pipe, st_6683_pstate, cta_coord_2, cta_layout_2, mcast_mask_2)
              mcast_mask_3, cta_coord_3, cta_layout_3 = shared.get_multicast_info(None, -1)
              shared.tma_copy(b_tma_atom_3, b_tma_tensor_3, st_6693, 256, 64, sched_coord[1], k, st_6693_pipe, st_6683_pstate, cta_coord_3, cta_layout_3, mcast_mask_3)
            st_6683_pstate.advance()
          if cutlass.const_expr(True):
