...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, b1: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_6581_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 128, False)
    wgmma_acc_6583_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 128, False)
    ...
    self.kernel(a, b, b1, st_6600_layout, st_6610_layout, st_6627_layout, c, rt_6648_epi_smem_layout, wgmma_acc_6581_tiled_mma, wgmma_acc_6583_tiled_mma, tiled_mma_8069, tiled_mma_8125, tiled_mma_8146, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, b1_tma_atom_4, b1_tma_tensor_4).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, b1: cute.Tensor, st_6600_layout, st_6610_layout, st_6627_layout, c: cute.Tensor, rt_6648_epi_smem_layout, wgmma_acc_6581_tiled_mma, wgmma_acc_6583_tiled_mma, tiled_mma_8069, tiled_mma_8125, tiled_mma_8146, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, b1_tma_atom_4, b1_tma_tensor_4):
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 256, 132):
        ...
        wgmma_acc_6581 = mma.get_acc(wgmma_acc_6581_tiled_mma, 128, 128, cutlass.Float32)
        wgmma_acc_6581_accumulate = False
        wgmma_acc_6583 = mma.get_acc(wgmma_acc_6583_tiled_mma, 128, 128, cutlass.Float32)
        wgmma_acc_6583_accumulate = False
        for k in cutlass.range(0, 128, 1):
          st_6627_pipe.consumer_wait(st_6610_cstate, st_6627_pipe.consumer_try_wait(st_6610_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8069, st_6600, st_6610, wgmma_acc_6583, st_6610_cstate, st_6610_cstate, wgmma_acc_6583_accumulate, -1)
          wgmma_acc_6583_accumulate = True
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8125, st_6600, st_6627, wgmma_acc_6581, st_6610_cstate, st_6610_cstate, wgmma_acc_6581_accumulate, -1)
          wgmma_acc_6581_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_6627_pipe.consumer_release(st_6610_cstate)
          st_6600_pstate.advance()
          st_6610_cstate.advance()
        rt_6644 = cute.make_rmem_tensor_like(wgmma_acc_6583, cutlass.Float32)
        rt_6644.store(elementwise.silu(wgmma_acc_6583.load()))
        rt_6648 = elementwise.tilewise_mul(rt_6644, wgmma_acc_6581)
