...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_1605_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 256, False)
    ...
    self.kernel(a, b, st_1577_layout, st_1595_layout, c, rt_1642_epi_smem_layout, tiled_mma_1616, wgmma_acc_1605_tiled_mma, tiled_mma_5457, tiled_mma_5506, tiled_mma_5525, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, st_1577_layout, st_1595_layout, c: cute.Tensor, rt_1642_epi_smem_layout, tiled_mma_1616, wgmma_acc_1605_tiled_mma, tiled_mma_5457, tiled_mma_5506, tiled_mma_5525, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3):
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 512, 132):
        ...
        wgmma_acc_1605 = mma.get_acc(wgmma_acc_1605_tiled_mma, 128, 256, cutlass.Float32)
        wgmma_acc_1605_accumulate = False
        for k in cutlass.range(0, 64, 1):
          st_1595_pipe.consumer_wait(st_1577_cstate, st_1595_pipe.consumer_try_wait(st_1577_cstate))
          rt_1587 = mma.copy_a_wgmma(tidx_, tiled_mma_5457, st_1577[None, None, st_1577_cstate.index], 128, 64, cutlass.BFloat16)
          mma.accumulating_gemm_rs(tidx_, tiled_mma_5506, rt_1587, st_1595, wgmma_acc_1605, st_1577_cstate, wgmma_acc_1605_accumulate, -1)
          wgmma_acc_1605_accumulate = True
        ...
        rt_1642 = elementwise.row_mul(wgmma_acc_1605, rt_1638)
