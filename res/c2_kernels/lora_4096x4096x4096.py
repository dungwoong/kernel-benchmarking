...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_3232_epi_smem_layout = shared.get_smem_layout_row_major(cutlass.BFloat16, 128, 64, 2)
    wgmma_acc_3232_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 256, False)
    ...
    c_tma_atom_1, c_tma_tensor_1 = shared.get_tma_epi_tensor_and_atom(c, wgmma_acc_3232_epi_smem_layout, 128, 64)
    ...
    self.kernel(a, b, xa, lora_b, st_3259_layout, st_3269_layout, st_3235_layout, st_3249_layout, c, wgmma_acc_3232_epi_smem_layout, wgmma_acc_3232_tiled_mma, tiled_mma_7368, tiled_mma_7424, tiled_mma_7473, tiled_mma_7492, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, st_3259_layout, st_3269_layout, st_3235_layout, st_3249_layout, c: cute.Tensor, wgmma_acc_3232_epi_smem_layout, wgmma_acc_3232_tiled_mma, tiled_mma_7368, tiled_mma_7424, tiled_mma_7473, tiled_mma_7492, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5):
    ...
    shared.smem_add_shared_tensor(SharedStorage_t, 'wgmma_acc_3232_epi_smem_ptr', cutlass.BFloat16, wgmma_acc_3232_epi_smem_layout, 1024)
    ...
    wgmma_acc_3232_epi_smem = shared.smem_get_tensor(smem_, 'wgmma_acc_3232_epi_smem_ptr', wgmma_acc_3232_epi_smem_layout)
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 512, 132):
        ...
        wgmma_acc_3232 = mma.get_acc(wgmma_acc_3232_tiled_mma, 128, 256, cutlass.Float32)
        wgmma_acc_3232_accumulate = False
        for k in cutlass.range(0, 64, 1):
          st_3269_pipe.consumer_wait(st_3259_cstate, st_3269_pipe.consumer_try_wait(st_3259_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_7368, st_3259, st_3269, wgmma_acc_3232, st_3259_cstate, st_3259_cstate, wgmma_acc_3232_accumulate, -1)
          wgmma_acc_3232_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_3269_pipe.consumer_release(st_3259_cstate)
          st_3259_pstate.advance()
          st_3259_cstate.advance()
        ...
        mma.accumulating_gemm_rs(tidx_, tiled_mma_7473, rt_3245, st_3249, wgmma_acc_3232, st_3235_cstate, wgmma_acc_3232_accumulate, -1)
        wgmma_acc_3232_accumulate = True
        cute.nvgpu.warpgroup.wait_group(0)
        st_3249_pipe.consumer_release(st_3235_cstate)
        st_3235_pstate.advance()
        st_3235_cstate.advance()
        store.mma_epilogue_tma(tiled_mma_7492, c_tma_tensor_1, c_tma_atom_1, wgmma_acc_3232_epi_smem, wgmma_acc_3232, 128, 256, sched_coord[0], sched_coord[1], tidx_, warpidx_, cutlass.Float32)
