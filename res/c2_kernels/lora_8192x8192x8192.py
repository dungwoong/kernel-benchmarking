...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_4587_epi_smem_layout = shared.get_smem_layout_row_major(cutlass.BFloat16, 128, 64, 2)
    wgmma_acc_4587_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 256, False)
    ...
    c_tma_atom_1, c_tma_tensor_1 = shared.get_tma_epi_tensor_and_atom(c, wgmma_acc_4587_epi_smem_layout, 128, 64)
    ...
    self.kernel(a, b, xa, lora_b, st_4615_layout, st_4629_layout, st_4595_layout, st_4605_layout, c, wgmma_acc_4587_epi_smem_layout, wgmma_acc_4587_tiled_mma, tiled_mma_7865, tiled_mma_7914, tiled_mma_8011, tiled_mma_8032, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, xa: cute.Tensor, lora_b: cute.Tensor, st_4615_layout, st_4629_layout, st_4595_layout, st_4605_layout, c: cute.Tensor, wgmma_acc_4587_epi_smem_layout, wgmma_acc_4587_tiled_mma, tiled_mma_7865, tiled_mma_7914, tiled_mma_8011, tiled_mma_8032, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, xa_tma_atom_4, xa_tma_tensor_4, lora_b_tma_atom_5, lora_b_tma_tensor_5):
    ...
    shared.smem_add_shared_tensor(SharedStorage_t, 'wgmma_acc_4587_epi_smem_ptr', cutlass.BFloat16, wgmma_acc_4587_epi_smem_layout, 1024)
    ...
    wgmma_acc_4587_epi_smem = shared.smem_get_tensor(smem_, 'wgmma_acc_4587_epi_smem_ptr', wgmma_acc_4587_epi_smem_layout)
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 2048, 132):
        ...
        wgmma_acc_4587 = mma.get_acc(wgmma_acc_4587_tiled_mma, 128, 256, cutlass.Float32)
        wgmma_acc_4587_accumulate = False
        for k in cutlass.range(0, 128, 1):
          st_4629_pipe.consumer_wait(st_4615_cstate, st_4629_pipe.consumer_try_wait(st_4615_cstate))
          rt_4625 = mma.copy_a_wgmma(tidx_, tiled_mma_7865, st_4615[None, None, st_4615_cstate.index], 128, 64, cutlass.BFloat16)
          mma.accumulating_gemm_rs(tidx_, tiled_mma_7914, rt_4625, st_4629, wgmma_acc_4587, st_4615_cstate, wgmma_acc_4587_accumulate, -1)
          wgmma_acc_4587_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_4629_pipe.consumer_release(st_4615_cstate)
          st_4615_pstate.advance()
          st_4615_cstate.advance()
        st_4605_pipe.consumer_wait(st_4605_cstate, st_4605_pipe.consumer_try_wait(st_4605_cstate))
        mma.accumulating_gemm_ss(tidx_, tiled_mma_8011, st_4595, st_4605, wgmma_acc_4587, st_4605_cstate, st_4605_cstate, wgmma_acc_4587_accumulate, -1)
        wgmma_acc_4587_accumulate = True
        cute.nvgpu.warpgroup.wait_group(0)
        st_4605_pipe.consumer_release(st_4605_cstate)
        st_4605_pstate.advance()
        st_4605_cstate.advance()
        store.mma_epilogue_tma(tiled_mma_8032, c_tma_tensor_1, c_tma_atom_1, wgmma_acc_4587_epi_smem, wgmma_acc_4587, 128, 256, sched_coord[0], sched_coord[1], tidx_, warpidx_, cutlass.Float32)
      ...
      if warpidx_ == 8:
        ...
        for sched_idx in cutlass.range(cute.arch.block_idx()[0], 2048, 132):
          ...
          for k in cutlass.range(0, 128, 1):
            ...
            st_4615_pstate.advance()
          if cutlass.const_expr(True):
            st_4605_pipe.producer_acquire(st_4605_pstate, st_4605_pipe.producer_try_acquire(st_4605_pstate))
            mcast_mask_4, cta_coord_4, cta_layout_4 = shared.get_multicast_info(None, -1)
            shared.tma_copy(xa_tma_atom_4, xa_tma_tensor_4, st_4595, 128, 16, sched_coord[0], 0, st_4605_pipe, st_4605_pstate, cta_coord_4, cta_layout_4, mcast_mask_4)
            mcast_mask_5, cta_coord_5, cta_layout_5 = shared.get_multicast_info(None, -1)
            shared.tma_copy(lora_b_tma_atom_5, lora_b_tma_tensor_5, st_4605, 256, 16, sched_coord[1], 0, st_4605_pipe, st_4605_pstate, cta_coord_5, cta_layout_5, mcast_mask_5)
          st_4605_pstate.advance()
