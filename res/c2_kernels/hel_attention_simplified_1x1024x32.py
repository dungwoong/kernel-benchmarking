...
class Kernel:
  ...
  def __call__(self, mQ: cute.Tensor, mK: cute.Tensor, mV: cute.Tensor, mO: cute.Tensor):
    ...
    tiled_mma_10398 = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 64, 16, False)
  ...
  def kernel(self, mQ: cute.Tensor, mK: cute.Tensor, mV: cute.Tensor, st_10352_layout, st_10370_layout, st_10420_layout, mO: cute.Tensor, rt_10445_epi_smem_layout, tiled_mma_10398, wgmma_acc_10436_tiled_mma, tiled_mma_11871, tiled_mma_11918, tiled_mma_11936, mO_tma_atom_1, mO_tma_tensor_1, mQ_tma_atom_2, mQ_tma_tensor_2, mK_tma_atom_3, mK_tma_tensor_3, mV_tma_atom_4, mV_tma_tensor_4):
    ...
    if warpidx_ >= 0 and warpidx_ < 4:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 32, 132):
        ...
        rt_10397 = reduction.make_mma_A_reduction_tensor(tiled_mma_10398, 64, 16, cutlass.Float32)
        ...
        for k in cutlass.range(0, 8, 1):
          ...
          reduction.row_sum_mixed_types(rt_10387_frgA, rt_10397, cutlass.Float32)
        ...
        rt_10397.store(reduction.warp_sum_row_mma_layout(rt_10397.load()))
        rt_10408 = cute.make_rmem_tensor_like(rt_10397, cutlass.Float32)
        rt_10408.store(elementwise.rcp(rt_10397.load()))
