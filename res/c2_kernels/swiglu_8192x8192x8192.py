...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, b1: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_6639_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 128, False)
  ...
  def kernel(self, a: cute.Tensor, b: cute.Tensor, b1: cute.Tensor, st_6596_layout, st_6606_layout, st_6616_layout, c: cute.Tensor, rt_6648_epi_smem_layout, wgmma_acc_6639_tiled_mma, wgmma_acc_6626_tiled_mma, tiled_mma_8069, tiled_mma_8125, tiled_mma_8146, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3, b1_tma_atom_4, b1_tma_tensor_4):
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 4096, 132):
        sched_coord = scheduler.remap_1d_idx(sched_idx, ((8, 8), (8, 8)), ((64, 1), (512, 8)), (64, 64), 8)
        wgmma_acc_6639 = mma.get_acc(wgmma_acc_6639_tiled_mma, 128, 128, cutlass.Float32)
        wgmma_acc_6639_accumulate = False
        ...
        for k in cutlass.range(0, 128, 1):
          st_6616_pipe.consumer_wait(st_6596_cstate, st_6616_pipe.consumer_try_wait(st_6596_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8069, st_6596, st_6606, wgmma_acc_6626, st_6596_cstate, st_6596_cstate, wgmma_acc_6626_accumulate, -1)
          wgmma_acc_6626_accumulate = True
          mma.accumulating_gemm_ss(tidx_, tiled_mma_8125, st_6596, st_6616, wgmma_acc_6639, st_6596_cstate, st_6596_cstate, wgmma_acc_6639_accumulate, -1)
          wgmma_acc_6639_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_6616_pipe.consumer_release(st_6596_cstate)
          st_6596_pstate.advance()
          st_6596_cstate.advance()
        rt_6635 = cute.make_rmem_tensor_like(wgmma_acc_6626, cutlass.Float32)
        rt_6635.store(elementwise.silu(wgmma_acc_6626.load()))
        rt_6648 = elementwise.tilewise_mul(rt_6635, wgmma_acc_6639)
