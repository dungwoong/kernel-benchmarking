...
class Kernel:
  ...
  def __call__(self, a: cute.Tensor, b: cute.Tensor, c: cute.Tensor):
    ...
    wgmma_acc_566_epi_smem_layout = shared.get_smem_layout_row_major(cutlass.BFloat16, 128, 64, 2)
    wgmma_acc_566_tiled_mma = mma.get_tiled_mma(cutlass.BFloat16, True, True, cutlass.Float32, 128, 256, False)
    ...
    c_tma_atom_1, c_tma_tensor_1 = shared.get_tma_epi_tensor_and_atom(c, wgmma_acc_566_epi_smem_layout, 128, 64)
    ...
    self.kernel(a, b, st_571_layout, st_581_layout, c, wgmma_acc_566_epi_smem_layout, wgmma_acc_566_tiled_mma, tiled_mma_1011, tiled_mma_1032, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3).launch(grid=[132, 1, 1], block=384)

  @cute.kernel
  def kernel(self, a: cute.Tensor, b: cute.Tensor, st_571_layout, st_581_layout, c: cute.Tensor, wgmma_acc_566_epi_smem_layout, wgmma_acc_566_tiled_mma, tiled_mma_1011, tiled_mma_1032, c_tma_atom_1, c_tma_tensor_1, a_tma_atom_2, a_tma_tensor_2, b_tma_atom_3, b_tma_tensor_3):
    ...
    shared.smem_add_shared_tensor(SharedStorage_t, 'wgmma_acc_566_epi_smem_ptr', cutlass.BFloat16, wgmma_acc_566_epi_smem_layout, 1024)
    ...
    wgmma_acc_566_epi_smem = shared.smem_get_tensor(smem_, 'wgmma_acc_566_epi_smem_ptr', wgmma_acc_566_epi_smem_layout)
    ...
    if warpidx_ >= 0 and warpidx_ < 8:
      ...
      for sched_idx in cutlass.range(cute.arch.block_idx()[0], 896, 132):
        ...
        wgmma_acc_566 = mma.get_acc(wgmma_acc_566_tiled_mma, 128, 256, cutlass.Float32)
        wgmma_acc_566_accumulate = False
        for k in cutlass.range(0, 128, 1):
          st_581_pipe.consumer_wait(st_571_cstate, st_581_pipe.consumer_try_wait(st_571_cstate))
          mma.accumulating_gemm_ss(tidx_, tiled_mma_1011, st_571, st_581, wgmma_acc_566, st_571_cstate, st_571_cstate, wgmma_acc_566_accumulate, -1)
          wgmma_acc_566_accumulate = True
          cute.nvgpu.warpgroup.wait_group(0)
          st_581_pipe.consumer_release(st_571_cstate)
          st_571_pstate.advance()
          st_571_cstate.advance()
        store.mma_epilogue_tma(tiled_mma_1032, c_tma_tensor_1, c_tma_atom_1, wgmma_acc_566_epi_smem, wgmma_acc_566, 128, 256, sched_coord[0], sched_coord[1], tidx_, warpidx_, cutlass.Float32)
